...
public class wardenLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("W a r d e n  L o g i n");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet res = sta.executeQuery("select * from wardendetails where wardenid='" + jTextField2.getText() + "'");
            if (res.next() == false) {
                JOptionPane.showMessageDialog(this, "Invalid User ID or Password");
            } else {
                do {
                    pas = res.getString("wardenpassword");
                } while (res.next());
