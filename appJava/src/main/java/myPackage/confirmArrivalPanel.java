 ...
 * @author User
 */
public class confirmArrivalPanel extends javax.swing.JFrame {

    /**
     * Creates new form confirmArrivalPanel
     */
    public confirmArrivalPanel() {
        ...
        try {
            ...
            ResultSet res = sta.executeQuery("select a.requestid,a.studentid,s.studentname,a.leftdatetime from outonrequest a, studentdetails s where a.studentid=s.studentid");
            if (res.next() == false) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("C o n f i r m  A r r i v a l");
    ...
    public void accept(String id) {
        ...
        try {
            ...
            ResultSet r = s.executeQuery("select * from outonrequest where requestid='" + id + "'");
            while (r.next()) {
                stud = r.getString("studentid");
                dt = r.getString("leftdatetime");
                type = r.getString("type");
                reason=r.getString("reason");
            }

            Statement st = con.createStatement();
            st.executeUpdate("insert into hostelleaverecords(studentid,leftdatetime,type,reason) values('" + stud + "','" + dt + "','" + type + "','"+ reason +"')");

            Statement sta = con.createStatement();
            sta.executeUpdate("delete from outonrequest where requestid='" + id + "'");
            this.dispose();
            confirmArrivalPanel n = new confirmArrivalPanel();
            n.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Object[] options = {"Confirm Arrival",
            "Cancel"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confirmArrivalPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new confirmArrivalPanel().setVisible(true);
            }
        });
    }
